...
* Broadcasting one's ID and informatiom to those nearby, can be done by putting the ID+health codes into the *BLE name* of the ESP32, and then telling it to advertise itself.
