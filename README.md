...
Google Chrome has [Web Bluetooth](https://developers.google.com/web/updates/2015/07/interact-with-ble-devices-on-the-web) built into it. It allows a browser (via JavaScript) to communicate with BLE devices. Thus the configuration tool for this contact tracer is an .html file.
